...
@Component({
  selector: 'app-forex-symbols',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './forex-symbols.component.html',
  styleUrl: './forex-symbols.component.css',
})
export class ForexSymbolsComponent implements OnInit {
  apiUrl: string = 'https://api.twelvedata.com/forex_pairs';
  symbols: any[] = [];

...
@Component({
  selector: 'app-indices-symbols',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './indices-symbols.component.html',
  styleUrl: './indices-symbols.component.css',
})
export class IndicesSymbolsComponent implements OnInit {
  apiUrl: string = 'https://api.twelvedata.com/indices';
  symbols: any[] = [];
